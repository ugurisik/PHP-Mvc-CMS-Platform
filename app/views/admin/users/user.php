        ...
        <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <div class="symbol symbol-150px symbol-circle mb-7">
                                <img src="<?= ADMIN_ASSETS ?>media/avatars/300-1.jpg" alt="image" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Name-->
                        ...
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">
                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary">#14534</a>
                            </div>
                            <!--begin::Details item-->
                        </div>
                        <!--end::Details content-->
            ...
            <div class="flex-lg-row-fluid ms-lg-15">
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#roles">Yetkiler</a>
                    </li>
                    <!--end:::Tab item-->
                </ul>
                <!--end:::Tabs-->
                                ...
                                <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                    ...
                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14985</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15399</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15645</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15433</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14641</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15719</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15977</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15531</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                        ...
                                        <tr>
                                            <!--begin::order=-->
                                            <td>
                                                <a href="../sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14665</a>
                                            </td>
                                            <!--end::order=-->
                                            <!--begin::Status=-->
                                            <td>
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?= ADMIN_ASSETS ?>media/avatars/300-1.jpg)"></div>
                                ...
                                <div class="py-0" data-kt-customer-payment-method="row">
                                    ...
                                    <div class="py-3 d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center collapsible rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                                            ...
                                            <!--end::Arrow-->
                                            <!--begin::Logo-->
                                            <img src="<?= ADMIN_ASSETS ?>media/svg/card-logos/mastercard.svg" class="w-40px me-3" alt="" />
                                            <!--end::Logo-->
                                            <!--begin::Summary-->
                                            <div class="me-3">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-equal me-5">
                                                <table class="table table-flush fw-semibold gy-1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-800">**** 8745</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-800">Australia
                                                            <div class="symbol symbol-20px symbol-circle ms-2">
                                                                <img src="<?= ADMIN_ASSETS ?>media/flags/australia.svg" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="py-0" data-kt-customer-payment-method="row">
                                    ...
                                    <div class="py-3 d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
                                            ...
                                            <!--end::Arrow-->
                                            <!--begin::Logo-->
                                            <img src="<?= ADMIN_ASSETS ?>media/svg/card-logos/visa.svg" class="w-40px me-3" alt="" />
                                            <!--end::Logo-->
                                            <!--begin::Summary-->
                                            <div class="me-3">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap py-5">
                                            ...
                                            <div class="flex-equal me-5">
                                                <table class="table table-flush fw-semibold gy-1">
                                                    ...
                                                    <tr>
                                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                                        <td class="text-gray-800">**** 5586</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                                                ...
                                                <table class="table table-flush fw-semibold gy-1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-800">United Kingdom
                                                            <div class="symbol symbol-20px symbol-circle ms-2">
                                                                <img src="<?= ADMIN_ASSETS ?>media/flags/united-kingdom.svg" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="py-0" data-kt-customer-payment-method="row">
                                    ...
                                    <div class="py-3 d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
                                            ...
                                            <!--end::Arrow-->
                                            <!--begin::Logo-->
                                            <img src="<?= ADMIN_ASSETS ?>media/svg/card-logos/american-express.svg" class="w-40px me-3" alt="" />
                                            <!--end::Logo-->
                                            <!--begin::Summary-->
                                            <div class="me-3">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap py-5">
                                            ...
                                            <div class="flex-equal me-5">
                                                <table class="table table-flush fw-semibold gy-1">
                                                    ...
                                                    <tr>
                                                        <td class="text-muted min-w-125px w-125px">Number</td>
                                                        <td class="text-gray-800">**** 1857</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-muted min-w-125px w-125px">Expires</td>
                                                ...
                                                <table class="table table-flush fw-semibold gy-1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-800">United States of America
                                                            <div class="symbol symbol-20px symbol-circle ms-2">
                                                                <img src="<?= ADMIN_ASSETS ?>media/flags/united-states.svg" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                            ...
                            <div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
                                <img src="<?= ADMIN_ASSETS ?>media/misc/qr.png" alt="Scan this QR code" />
                            </div>
                            <!--end::QR code-->
                            <!--begin::Text code-->
...
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/transaction-history.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/add-auth-app.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/add-address.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/add-one-time-password.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/update-password.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/update-phone.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/update-address.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/ecommerce/customers/details/update-profile.js"></script>
<script src="<?= ADMIN_ASSETS ?>js/custom/apps/user-management/roles/list/update-role.js"></script>