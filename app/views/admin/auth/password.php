...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
				...
				<div class="d-flex flex-center w-lg-50 p-10">
					...
					<div class="card rounded-3 w-md-550px">
						...
						<div class="card-body p-10 p-lg-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="/metronic8/demo38/../demo38/authentication/layouts/creative/sign-in.html" action="#">
								<!--begin::Heading-->
		...
		<script src="https://preview.keenthemes.com/metronic8/demo38/assets/js/custom/authentication/password-reset/new-password.js"></script>
