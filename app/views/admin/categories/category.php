<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/metronic8/demo38/../demo38/apps/ecommerce/catalog/categories.html">
            <!--begin::Aside column-->
...
<script src="<?= ADMIN_ASSETS ?>/js/custom/apps/ecommerce/catalog/save-category.js"></script>