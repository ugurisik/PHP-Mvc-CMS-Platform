...
<head>
    <title>IMER Yönetim Paneli</title>
    <meta charset="utf-8" />
    <meta name="description" content="IMER ile sitenizi kurun ve yönetin." />
    <meta name="keywords" content="imer,kurumsal yazılım,website,tasarım" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="IMER ile sitenizi kurun ve yönetin." />
    <meta property="og:url" content="https://imeryazilim.com/" />
    <meta property="og:site_name" content="IMER Yönetim Paneli" />
            ...
            <div id="kt_app_header" class="app-header">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                        ...
                        <!--begin::Logo image-->
                        <a href="index.html">
                            <img alt="Logo" src="<?= ADMIN_ASSETS ?>media/logos/demo38-small.svg" class="h-30px" />
                        </a>
                        <!--end::Logo image-->
                    </div>
                    <!--end::Sidebar toggle-->
                    ...
                    <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                        <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                            ...
                            <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-200px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                                ...
                                <span class="fs-3 fw-bold"><?= $param['pageTitle'] ?></span>
                            </div>
                        </div>
                        ...
                        <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-circle symbol-35px symbol-md-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                <img src="<?= ADMIN_ASSETS ?>media/avatars/300-2.jpg" alt="user" />
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="Logo" src="<?= ADMIN_ASSETS ?>media/avatars/300-2.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Username-->
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold d-flex align-items-center fs-5">Uğur IŞIK
                                            </div>
                                            <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">lorem@lorem.com</a>
                                        </div>
                                        <!--end::Username-->
                                    </div>
                                </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="account/overview.html" class="menu-link px-5">Hesap Ayarlarım</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                <div class="separator my-2"></div>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">Tema Modu
                                    ...
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">Dil
                                            <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Türkçe
                                                <img class="w-15px h-15px rounded-1 ms-2" src="<?= ADMIN_ASSETS ?>media/flags/turkey.svg" alt="" /></span></span>
                                    </a>
                                    <!--begin::Menu sub-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="<?= ADMIN_ASSETS ?>media/flags/turkey.svg" alt="" />
                                                </span>Türkçe</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    <div class="app-sidebar-header d-flex flex-stack d-none d-lg-flex pt-8 pb-2" id="kt_app_sidebar_header">
                        ...
                        <a href="index.html" class="app-sidebar-logo">
                            <img alt="Logo" src="<?= ADMIN_ASSETS ?>media/logos/demo38.svg" class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
                            <img alt="Logo" src="<?= ADMIN_ASSETS ?>media/logos/demo38-dark.svg" class="h-20px h-lg-25px theme-dark-show" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Sidebar toggle-->
                    ...
                    <div class="app-sidebar-navs flex-column-fluid py-6" id="kt_app_sidebar_navs">
                        <div id="kt_app_sidebar_navs_wrappers" class="app-sidebar-wrapper hover-scroll-y my-2" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_header" data-kt-scroll-wrappers="#kt_app_sidebar_navs" data-kt-scroll-offset="5px">
                            ...
                            <!--end::Teams-->
                            <!--begin::Sidebar menu-->
                            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="app-sidebar-menu-secondary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary">
                                <!--begin::Heading-->
                                <!--begin::Menu Item-->
                                <div class="menu-item">
                                    <!--begin::Menu link-->
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>settings">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>users">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>users/add">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>categories">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>categories/add">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>product">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="<?= ADMIN_URL ?>product/add">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <div class="menu-item">
                                                    <a class="menu-link" href="#link">
                                                        ...
                                                        <span class="menu-title">En Alt Menü</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
